...
public class  QuestionController {
    ...
    @GetMapping("generate")
    @CircuitBreaker(name = "questionServiceBreaker", fallbackMethod = "questionFallback")
    ...
    // Fallback method
    public ResponseEntity<List<Integer>> questionFallback(String categoryName, Integer numQuestion, Exception e) {
        System.out.println("Fallback executed for getQuestionForQuiz: " + e.getMessage());
